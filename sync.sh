...
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-5.x/archetype/alloy-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-5.x/archetype/metal-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
...
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-4.x/archetype/alloy-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-4.x/archetype/metal-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
...
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-3.x/archetype/alloy-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-3.x/archetype/metal-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
...
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-2.x/archetype/alloy-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
# dir=~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-2.x/archetype/metal-portlet
# if [ ! -d $dir ]; then mkdir -p $dir && echo made $dir ...; fi
...
rsync -vax deps/archetypes/liferay-faces-metal/war/liferay/7.0.x/jsf-2.2/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-5.x/archetype/metal-portlet/.
...
rsync -vax deps/archetypes/liferay-faces-alloy/war/liferay/7.0.x/jsf-2.1/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-4.x/archetype/alloy-portlet/.
rsync -vax deps/archetypes/liferay-faces-metal/war/liferay/7.0.x/jsf-2.1/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-4.x/archetype/metal-portlet/.
...
rsync -vax deps/archetypes/liferay-faces-alloy/war/liferay/6.2.x/jsf-2.2/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-3.x/archetype/alloy-portlet/.
rsync -vax deps/archetypes/liferay-faces-metal/war/liferay/6.2.x/jsf-2.2/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-3.x/archetype/metal-portlet/.
...
rsync -vax deps/archetypes/liferay-faces-alloy/war/liferay/6.2.x/jsf-2.1/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-2.x/archetype/alloy-portlet/.
rsync -vax deps/archetypes/liferay-faces-metal/war/liferay/6.2.x/jsf-2.1/* ~/Projects/liferay.com/liferay-faces/liferay-faces-bridge-ext-2.x/archetype/metal-portlet/.
