...
angular.module('liferay-faces-deps', [])
	.controller('depsController', ['$scope', function($scope) {
		...
		var jsfs = [
			{ name: 'jsf-2.1', builds: builds },
			{ name: 'jsf-2.2', builds: builds },
			{ name: 'jsf-2.3', builds: builds }
		];
		...
		var suites = [
			...
			{ name: 'liferay-faces-alloy', servlets: servlets },
			{ name: 'liferay-faces-crystal', servlets: servlets },
